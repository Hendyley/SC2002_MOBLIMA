...
public class MovieGoerModuleApp {
    ...
    public String[] holidays2 = { "2022-01-01", "2022-02-01", "2022-02-02", "2022-04-15", "2022-05-01", "2022-05-03",
    ...
    public static void main(String[] args) throws Exception {
        ...
        cinema roomstyle1 = new cinema();

        movie1.addSlot(new TimeSlot("2022-10-31", "1500", "1700", ClassOfCinama.DOLBY, roomstyle1));
        movie1.addSlot(new TimeSlot("2022-10-31", "1300", "1500", ClassOfCinama.DOLBY, roomstyle1));
        movie1.addSlot(new TimeSlot("2022-11-02", "0900", "1100", ClassOfCinama.DOLBY, roomstyle1));

        movie2.addSlot(new TimeSlot("2022-10-31", "1500", "1700", ClassOfCinama.DOLBY, roomstyle1));
        movie2.addSlot(new TimeSlot("2022-10-31", "1300", "1500", ClassOfCinama.DOLBY, roomstyle1));
        movie2.addSlot(new TimeSlot("2022-11-02", "0900", "1100", ClassOfCinama.DOLBY, roomstyle1));

        movie3.addSlot(new TimeSlot("2022-10-31", "1500", "1700", ClassOfCinama.DOLBY, roomstyle1));
        movie3.addSlot(new TimeSlot("2022-10-31", "1300", "1500", ClassOfCinama.DOLBY, roomstyle1));
        movie3.addSlot(new TimeSlot("2022-11-02", "0900", "1100", ClassOfCinama.DOLBY, roomstyle1));

        cathay[0].getMovieList().add(movie1);
        cathay[0].getMovieList().add(movie2);
        cathay[0].getMovieList().add(movie3);
        ...
        do {
            ...
            switch (option) {
                ...
                case 3:
                    ...
                    // if ((Float.valueOf(ts.getStartTime()) <= time && time <
                    // Float.valueOf(ts.getEndTime()))) {
                    // if (ts.getAiringmovie().getTitle().toLowerCase().indexOf(movie.toLowerCase())
                    // > -1) {
                    // System.out.println("Airing movie :" + ts.getAiringmovie().getTitle() + "
                    // time:"
