...
public class testLoginApp2 {
    ...
    public String[] holidays = { "01/01/2022", "01/02/2022", "02/02/2022",
...
public static ArrayList<Object> getAccountListsFromFile() throws IOException,
...
System.out.println("Account List File not found, creating new Account List
File");
}
...
return accountLists;
    ...
    public static void addAccountListsToFile(ArrayList<Object> accountLists)
            throws IOException {
        FileOutputStream fileOutputStream = new FileOutputStream(ACCOUNT_FILE_NAME);
    ...
    private static void generateDummyData() throws ClassNotFoundException,
            IOException {
...
private static void printAccountLists() throws ClassNotFoundException,
IOException{
ArrayList<Object> accountLists = getAccountListsFromFile();
ArrayList<Staff> staffList = (ArrayList<Staff>)accountLists.get(0);
ArrayList<MovieGoer> mgList = (ArrayList<MovieGoer>)accountLists.get(1);
...
for(Staff s : staffList){
System.out.printf("username: %s ,password: %s ,role:
...
System.out.printf("name: %s ,email: %s ,mobile:
...
System.out.printf("Transaction List: %s \n",mg.getTransactionHistory());
    ...
    public static boolean login(ArrayList<Object> accountLists, String username,
            String password) {
        ArrayList<Staff> staffList = (ArrayList<Staff>) accountLists.get(0);
        ArrayList<MovieGoer> mgList = (ArrayList<MovieGoer>) accountLists.get(1);
    ...
    public static void switch_case_login() throws ClassNotFoundException,
            IOException {
        String username;
        String password;
